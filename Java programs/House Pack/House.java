 ...
 *  
 *  * Purpose: This is a house class used in conjunction with a person class that together help implement a home buying sim main method.
 *  
 *  
 *  
 *  
...
public class House {
	...
	public boolean equals(House h) {
		...
		if (this.color == h.color && this.price == h.price && this.height == h.height && this.width == h.width && this.length == h.length && this.forSale == h.forSale) {
